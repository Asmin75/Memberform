...
class Member(models.Model):
    ...
    office_email = models.EmailField(max_length=100, blank=True)
    office_phone = models.CharField(max_length=100, blank=True)
    residence_phone = models.CharField(max_length=100, blank=True)
